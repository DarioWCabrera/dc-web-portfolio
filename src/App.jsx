...
const projects = [
  ...
  },
  {
    ...
    liveUrl: PRODUCT_LINKS.fotolive,
    summary:
  ...
  },
  {
    ...
    cover: rominaWeb,
    images: [rominaWeb],
    liveUrl: 'https://romina-avila-counselor.com.ar/',
    summary:
    ...
    description: [
      ...
      'El proyecto prioriza una navegación simple, una estética cercana y una experiencia responsive. El sitio fue finalizado, publicado y entregado con dominio propio.',
    ],
    highlights: ['Diseño personalizado', 'Contenido organizado', 'Responsive', 'Contacto por WhatsApp', 'Dominio propio'],
  ...
  },
  {
    ...
    cover: marielaWeb,
    images: [marielaWeb],
    liveUrl: 'https://counselor-mariela-boglione.com.ar/',
    summary:
    ...
    description: [
      ...
      'La web está adaptada a distintos dispositivos y fue finalizada, publicada y entregada con su dominio propio.',
    ],
    highlights: ['Identidad visual', 'Diseño responsive', 'WhatsApp y correo', 'Navegación clara', 'Dominio propio'],
    technologies: ['HTML', 'CSS', 'JavaScript', 'Netlify'],
  },
  {
    id: 'jonathan',
    ...
    cover: jonathanWeb,
    images: [jonathanWeb],
    liveUrl: 'https://counselor-jonathan-garcetti.com.ar/',
    summary:
    ...
    description: [
      ...
      'La estructura organiza una gran cantidad de información sin perder claridad. El proyecto fue finalizado, publicado y entregado con dominio propio.',
    ],
    highlights: ['Diseño editorial', 'Identidad personalizada', 'Estructura completa', 'Responsive', 'Dominio propio'],
    technologies: ['HTML', 'CSS', 'JavaScript', 'Netlify'],
  },
  {
    id: 'tecnoforza-web',
    title: 'TecnoForza',
    category: 'Sitio web institucional industrial',
    status: 'Sitio publicado',
    cover: 'https://tecnoforza.com.ar/assets/img/obra-industrial-01.webp',
    images: ['https://tecnoforza.com.ar/assets/img/obra-industrial-01.webp'],
    liveUrl: 'https://tecnoforza.com.ar/',
    summary:
      'Web institucional para presentar servicios eléctricos y electromecánicos, experiencia en campo y canales de contacto comercial.',
    description: [
      'Sitio institucional desarrollado para TecnoForza con foco en comunicar sus servicios industriales, capacidad técnica y experiencia de trabajo.',
      'La propuesta organiza servicios, proyectos, información corporativa y contacto dentro de una experiencia responsive, profesional y orientada a empresas.',
    ],
    highlights: ['Web institucional', 'Servicios industriales', 'Diseño responsive', 'Contacto comercial', 'Dominio propio'],
    technologies: ['HTML', 'CSS', 'JavaScript', 'Responsive'],
  },
  {
    id: 'tsi-tecnoforza',
    title: 'TSI TecnoForza',
    category: 'Catálogo digital de seguridad industrial',
    status: 'Catálogo publicado',
    cover: 'https://tsi-tecnoforza.netlify.app/assets/hero/proteccion-integral.webp',
    images: ['https://tsi-tecnoforza.netlify.app/assets/hero/proteccion-integral.webp'],
    liveUrl: 'https://tsi-tecnoforza.netlify.app/',
    summary:
      'Catálogo web para explorar productos de seguridad industrial, armar una cotización y enviarla de forma simple por WhatsApp.',
    description: [
      'Catálogo digital desarrollado para TSI TecnoForza Seguridad Industrial con categorías, productos, filtros y una experiencia pensada para clientes particulares y empresas.',
      'Los usuarios pueden reunir productos, ajustar cantidades y generar una solicitud de cotización agrupada, simplificando el contacto comercial desde la propia web.',
    ],
    highlights: ['Catálogo de productos', 'Filtros y búsqueda', 'Lista de cotización', 'Integración con WhatsApp', 'Diseño responsive'],
    technologies: ['HTML', 'CSS', 'JavaScript', 'Catálogo web'],
  },
        ...
        <section className="section projects-section" id="proyectos">
          <div className="container">
            ...
            <div className="institutional-title">
              <span className="eyebrow">Sitios profesionales y comerciales</span>
              <h3>Proyectos reales, publicados y listos para visitar.</h3>
              <p>Webs desarrolladas para profesionales y empresas, con identidad propia, dominio público y soluciones adaptadas a cada actividad.</p>
            </div>
              ...
              {projects.filter((project) => !project.featured).map((project) => (
                <article className="project-card project-card-compact" key={project.id}>
                  ...
                  <div className="project-content">
                    ...
                    <h3>{project.title}</h3>
                    <p>{project.summary}</p>
                    <div className="project-actions compact-project-actions">
                      <button className="text-button" type="button" onClick={() => openProject(project)}>
                        Ver detalles <ArrowIcon />
                      </button>
                      {project.liveUrl && (
                        <a className="project-live-link" href={project.liveUrl} target="_blank" rel="noreferrer">
                          Visitar sitio <ExternalIcon />
                        </a>
                      )}
                    </div>
                  </div>
